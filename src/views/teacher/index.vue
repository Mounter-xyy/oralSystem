                ...
                <div class="col-md-12">
                    ...
                    <ul class="btn-edit fl">
                        <li class="input-serach">
                            ...
                            <el-select v-model="keywords2" v-if="teacherLevel=='1'" filterable>
                    ...
                    <ul class="btn-edit fr">
                        <li >
                            <el-button type="primary" icon="el-icon-plus" @click="showme()" v-if="teacherLevel=='1'">添加教师</el-button>
                            <el-button type="danger" icon="delete" :disabled="selected.length==0" @click="removeUsers()" v-if="teacherLevel=='1'">删除</el-button>
                        </li>
                    </ul>
                    <!-- 用户列表-->
                    <el-table :data="users"
